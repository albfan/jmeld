...
/**  JXGroupableTableHeader
   ...
   @author Erik Vickroy
 */
public class JXGroupableTableHeader
       extends JXTableHeader
{
  protected List<ColumnGroup> groups = null;
  public static final String  muiClassID = "swingx/GroupableTableHeaderUI";
  ...
  public ColumnGroup addColumnGroup(
    Object        headerValue,
    TableColumn[] columns)
  {
    ...
    int    columnEnd)
  {
    ...
    for (int columnIndex = columnStart, index = 0; columnIndex <= columnEnd;
      columnIndex++, index++)
    {
