/*
 * $Id: LookAndFeelAddons.java,v 1.4 2006/03/31 04:27:43 evickroy Exp $
 *
...
public class LookAndFeelAddons
{
  ...
  static
  {
    ...
    contribute(
      new AbstractComponentAddon("MinimumAddon")
      {
        @Override
  ...
  {
    for (Iterator<ComponentAddon> iter = contributedComponents.iterator();
      iter.hasNext();)
    {
  ...
  public static String getBestMatchAddonClassName()
  {
    ...
    else if ("com.sun.java.swing.plaf.windows.WindowsClassicLookAndFeel".equals(
        lnf))
    {
      addon = WindowsClassicLookAndFeelAddons.class.getName();
    }
...
//      addon = getSystemAddonClassName();
   ...
   */
  public static ComponentUI getUI(
    ...
    Class      expectedUIClass)
  {
    ...
    else
    {
      ...
      try
      {
        createUIMethod = realUIClass.getMethod(
            "createUI",
            new Class[] { JComponent.class });
      }
      catch (NoSuchMethodException e1)
      {
        throw new RuntimeException("Class " + realUI
          + " has no method createUI(JComponent)");
      }
      try
      {
        return (ComponentUI) createUIMethod.invoke(
          null,
          new Object[] { component });
      }
      catch (Exception e2)
      {
        throw new RuntimeException("Failed to invoke " + realUI
          + "#createUI(JComponent)");
      }
    }
  }
