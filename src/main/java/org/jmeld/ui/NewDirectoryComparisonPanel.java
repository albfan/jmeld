...
public class NewDirectoryComparisonPanel extends SwingWorker<String, Object> {
    ...
    public NewDirectoryComparisonPanel(JMeldPanel mainPanel, File leftFile, File rightFile, Filter filter) {
        ...
        try {
            ...
            if (result != null) {
                ...
                if (contentPanel != null) {
                    ...
                    mainPanel.getTabbedPane().addTab(panel.getTitle(), ImageUtil
