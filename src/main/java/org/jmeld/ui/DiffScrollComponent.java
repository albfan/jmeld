...
public class DiffScrollComponent extends JComponent implements ChangeListener, ConfigurationListenerIF {
    ...
    private void initSettings() {
        ...
        //TODO: Añadir a settings este modo de pintar (curvas)
        simpleDraw = false;
    }
            ...
            for (JMDelta delta : revision.getDeltas()) {
                ...
                if (simpleDraw) {
                    ...
                    if (curveType == 0) {
                        ...
                        int posyOrg = original.getSize() > 0 ? 0 : 3;
                        int posyRev = revised.getSize() > 0 ? 0 : 3;
                        ...
                        curve.append(new CubicCurve2D.Float(curveX3, curveY3 + posyRev
